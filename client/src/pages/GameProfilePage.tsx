        ...
        <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-tr from-bg-start to-bg-end">
            ...
            <div className="flex flex-col items-center justify-center gap-3 border-4 border-white rounded-xl bg-white bg-opacity-10 mt-5">
                ...
                <div className="flex flex-row items-center justify-center m-6 mt-16 gap-4">
                    <input type="text" className="w-72 h-14 text-2xl text-center text-black border-4 bg-white rounded-md placeholder:text-black" placeholder="Nickname" value={gamePin} onChange={(e) => setName(e.target.value)} />
            ...
            <button className="w-72 h-16 text-2xl text-center text-black bg-white border-black border-4 rounded-md font-bold shadow-solid-primary absolute bottom-12" onClick={() => navigate(`/game/${gamePin}`)}>START</button>
        </div>
