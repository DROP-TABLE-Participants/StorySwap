    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-tr from-bg-start to-bg-end">
            ...
            <div className="flex flex-col items-center justify-center gap-3 mt-16">
                ...
                <button className="w-64 h-14 text-2xl text-center text-black bg-white border-black border-4 rounded-md font-bold shadow-solid-primary" onClick={() => navigate(`/game/${gamePin}`, { state: { gamePin } })}>Join</button>
